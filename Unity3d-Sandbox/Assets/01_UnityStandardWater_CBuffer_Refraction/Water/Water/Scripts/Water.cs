...
public class Water : MonoBehaviour
{
    ...
    public CameraEvent cameraEvent = CameraEvent.AfterSkybox;
    public BuiltinRenderTextureType builtinRenderTextureType = BuiltinRenderTextureType.CurrentActive;
    private Dictionary<Camera, CommandBuffer> m_Cameras = new Dictionary<Camera, CommandBuffer>();
    private bool isRefract;
